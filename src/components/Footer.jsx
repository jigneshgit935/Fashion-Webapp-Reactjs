  ...
  return (
    <footer className=" bg-PrimaryColor text-ExtraDarkColor rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div>
          <h1 className=" font-semibold text-3xl pb-4">CollectUrs</h1>
        ...
        <div className=" w-full md:w-1/4">
          ...
          <nav className=" flex flex-col gap-2">
            <Link to="/" spy={true} smooth={true} duration={500}>
              Rajasthan, Udaipur - Debari, 3001301. Raddison First Floor
            </Link>
            <Link to="/" spy={true} smooth={true} duration={500}>
              collecturs@style.com
            </Link>
            <Link to="/" spy={true} smooth={true} duration={500}>
              +123-456-7890
            </Link>
      ...
      <div>
        <p className=" text-center py-4">
          ...
          <span className=" text-black"> CollectUrs</span> | All rights reserved
        </p>
      </div>
    </footer>
  );
